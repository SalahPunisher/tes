...
print '<div class="container col-lg-6">
        ...
        <form name="form" id="form" method="POST" enctype="multipart/form-data" action="">
            ...
            <button type="submit" class="btn btn-default btn-sm" form="form" name="action" value="send">SEND</button> or <a href="#" onclick="document.getElementById(\'form\').submit(); return false;">ch3ck Sp4mAssass1n Sc@re.</a>
